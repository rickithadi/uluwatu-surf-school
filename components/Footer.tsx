        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <Link
                href="https://www.facebook.com/uluwatusurfschool"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visit Uluwatu Surf School on Facebook"
                className="text-gray-400 hover:text-white transition-colors"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="https://www.youtube.com/@uluwatusurfschool"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Watch Uluwatu Surf School on YouTube"
                className="text-gray-400 hover:text-white transition-colors"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="https://www.tiktok.com/@uluwatusurfschool"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow Uluwatu Surf School on TikTok"
                className="text-gray-400 hover:text-white transition-colors"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/#scoot" className="text-gray-400 hover:text-white transition-colors">Meet Scoot</Link></li>
